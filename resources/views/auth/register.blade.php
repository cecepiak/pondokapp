...
<div class="text-center mb-6">
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div>
            ...
            <input id="nik" type="text" name="nik" placeholder="Masukkan NIK" value="{{ old('nik') }}" required autofocus
        ...
        <div>
            ...
            <input id="no_kk" type="text" name="no_kk" placeholder="Masukkan Nomor KK" value="{{ old('no_kk') }}" required
                oninput="this.value=this.value.replace(/[^0-9]/g,'').slice(0,16)"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50
        ...
        <div>
            ...
            <input id="name" type="text" name="name" placeholder="Masukkan Nama Lengkap" value="{{ old('name') }}" required autocomplete="name"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50
        ...
        <div>
            ...
            <select id="kecamatan" name="kecamatan" required
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 @error('kecamatan') border-red-500 @enderror">
        ...
        <div>
            ...
            <select id="desa_kelurahan" name="desa_kelurahan" required
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 @error('desa_kelurahan') border-red-500 @enderror">
        ...
        <div>
            ...
            <input id="email" type="email" name="email" placeholder="Masukkan e-Mail" value="{{ old('email') }}" required autocomplete="email"
        ...
        <div>
            ...
            <input id="no_hp" type="text" name="no_hp" placeholder="Masukkan Nomor WhatsApp" value="{{ old('no_hp') }}" required
                oninput="this.value=this.value.replace(/[^0-9]/g,'')"
                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 @error('no_hp') border-red-500 @enderror">
            @error('no_hp')
                <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
            @enderror
        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        kecamatanDropdown.addEventListener('change', function () {
            ...
            if (kecamatanId) {
                fetch(`/get-desa?id_kecamatan=${kecamatanId}`) // Panggil rute API yang baru dibuat
