...
<div class="w-full max-w-sm bg-white/30 backdrop-blur-sm rounded-xl shadow-xl p-8 transform transition-transform duration-300 hover:scale-105">
<div class="text-center mb-6">
{{-- Ikon Passkey sebagai SVG --}}
<div class="bg-blue-600 rounded-full w-24 h-24 flex items-center justify-center mx-auto mb-4 shadow-lg text-white">
...
<path d="M21 2L2 22M21 21L12 12" />
<path d="M16 11V7a4 4 0 00-8 0v4m-3 0h14" />
</svg>
</div>
<h2 class="text-3xl font-bold text-gray-800 text-center mb-2">Login</h2>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between mt-6">
            <button type="submit" class="w-full sm:w-auto flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-lg focus:outline-none focus:shadow-outline transition-colors duration-200 shadow-md">
